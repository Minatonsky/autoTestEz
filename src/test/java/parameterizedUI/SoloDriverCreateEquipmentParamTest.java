...
//    Others
        ...
        equipmentPage.enterInspectionDue(inspectionDueDate);
        equipmentPage.enterNinetyDayExp(ninetyDayExpDate);
        equipmentPage.enterProRate(proRateDueDate);
        equipmentPage.enterExpDate(expDateDate);
